...
from beamable_python_sdk.exceptions_base import ApiValueError
from beamable_python_sdk.exceptions import ClientConfigurationError
...
conf = beamable_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.beamable.com" if host is None else host
        """Default Base url
        """
        ...
        if api:
            ...
            raise ClientConfigurationError('API Key "api" is required')
        if scope:
            self.api_key['scope'] = scope
        else:
            raise ClientConfigurationError('API Key "scope" is required')
        if user_required:
            self.api_key['userRequired'] = user_required
        else:
            raise ClientConfigurationError('API Key "userRequired" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("beamable_python_sdk")
    ...
    def auth_settings(self):
        ...
        if 'userRequired' in self.api_key:
            auth['userRequired'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-DE-GAMERTAG',
