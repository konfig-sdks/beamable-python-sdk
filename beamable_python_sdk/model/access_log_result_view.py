...
class AccessLogResultView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date", "count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date", "count", ], str]):
