...
class AliasAvailableResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["alias", "available", "cid", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["alias", "available", "cid", ], str]):
