...
class AvailabilityRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "tag", "type", "subGroup", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "tag", "type", "subGroup", ], str]):
