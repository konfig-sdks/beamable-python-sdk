...
class DonationEntry(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["playerId", "amount", "time", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["playerId", "amount", "time", ], str]):
