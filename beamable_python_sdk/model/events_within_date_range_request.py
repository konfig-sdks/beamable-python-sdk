...
class EventsWithinDateRangeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["from", "to", "query", "limit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["from", "to", "query", "limit", ], str]):
