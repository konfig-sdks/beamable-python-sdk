...
class FailPurchaseRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["txid", "reason", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["txid", "reason", ], str]):
