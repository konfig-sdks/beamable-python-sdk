...
class Friend(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["playerId", "source", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["playerId", "source", ], str]):
