...
class GetActiveListingRequest(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["listing"]) -> MetaOapg.properties.listing: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["listing", "store", "time", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["listing"]) -> typing.Union[MetaOapg.properties.listing, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["listing", "store", "time", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        listing: typing.Union[MetaOapg.properties.listing, str, schemas.Unset] = schemas.unset,
