...
class GetOrderInfoRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["orderId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["orderId", ], str]):
