...
class GetTemplateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["gamerTag", "templateName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["gamerTag", "templateName", ], str]):
