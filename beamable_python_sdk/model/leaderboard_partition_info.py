...
class LeaderboardPartitionInfo(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            partition = schemas.AnyTypeSchema
            __annotations__ = {
                "playerId": playerId,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["playerId", "leaderboardId", "partition", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["playerId", "leaderboardId", "partition", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        partition: typing.Union[MetaOapg.properties.partition, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, schemas.Unset] = schemas.unset,
