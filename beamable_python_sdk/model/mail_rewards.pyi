...
class MailRewards(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["currencies", "items", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["currencies", "items", ], str]):
