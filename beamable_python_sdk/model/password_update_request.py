...
class PasswordUpdateRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["email", "codeType", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["email", "codeType", ], str]):
