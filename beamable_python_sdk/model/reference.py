...
class Reference(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contentPrefix", "visibility", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contentPrefix", "visibility", "type", ], str]):
