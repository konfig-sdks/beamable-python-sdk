...
class RegisterReq(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["provider", "token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["provider", "token", ], str]):
