...
class ScheduleTrialRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["time", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["time", "name", ], str]):
