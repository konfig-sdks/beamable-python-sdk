...
class SendMailRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["receiverGamerTag", "senderGamerTag", "body", "expires", "subject", "id", "category", "bodyRef", "attachments", "rewards", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["receiverGamerTag", "senderGamerTag", "body", "expires", "subject", "id", "category", "bodyRef", "attachments", "rewards", ], str]):
