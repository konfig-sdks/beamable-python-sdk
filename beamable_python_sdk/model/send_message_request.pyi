...
class SendMessageRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["roomId", "content", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["roomId", "content", ], str]):
