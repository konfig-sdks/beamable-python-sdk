...
class SessionHeartbeat(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["gt", "heartbeat", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["gt", "heartbeat", ], str]):
