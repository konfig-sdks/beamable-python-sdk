...
class TournamentClientView(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["secondsRemaining", "tournamentId", "contentId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["secondsRemaining", "tournamentId", "contentId", ], str]):
