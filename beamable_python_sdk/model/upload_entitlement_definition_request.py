...
class UploadEntitlementDefinitionRequest(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class entitlements(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ModifyEntitlementDefinitionRequest']:
                        return ModifyEntitlementDefinitionRequest
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ModifyEntitlementDefinitionRequest'], typing.List['ModifyEntitlementDefinitionRequest']],
                ...
                def __getitem__(self, i: int) -> 'ModifyEntitlementDefinitionRequest':
