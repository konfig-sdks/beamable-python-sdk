...
class UploadRequestFromPortal(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["sizeInBytes", "objectKey", "metadata", "lastModified", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["sizeInBytes", "objectKey", "metadata", "lastModified", ], str]):
