...
class BaseApi(api_client.Api):
    ...
    def _search_groups_mapped_args(
        self,
    ...
    async def _asearch_groups_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/groups/search',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SearchGroupsRaw(BaseApi):
    ...
    async def asearch_groups(
        ...
        **kwargs,
        ...
        args = self._search_groups_mapped_args(
            name=name,
            score_min=score_min,
        ...
        return await self._asearch_groups_oapg(
    ...
    def search_groups(
        ...
        return self._search_groups_oapg(
            query_params=args.query,
        )
...
class SearchGroups(BaseApi):
    ...
    async def asearch_groups(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asearch_groups(
            name=name,
            score_min=score_min,
            sort_field=sort_field,
            user_score=user_score,
    ...
    def search_groups(
        ...
        raw_response = self.raw.search_groups(
            name=name,
            score_min=score_min,
            sort_field=sort_field,
            user_score=user_score,
