...
from beamable_python_sdk.model.reschedule_message_campaign_request import RescheduleMessageCampaignRequest as RescheduleMessageCampaignRequestSchema

from beamable_python_sdk.type.reschedule_message_campaign_request import RescheduleMessageCampaignRequest
...
from beamable_python_sdk.pydantic.reschedule_message_campaign_request import RescheduleMessageCampaignRequest as RescheduleMessageCampaignRequestPydantic

# body param
SchemaForRequestBodyApplicationJson = RescheduleMessageCampaignRequestSchema


request_body_reschedule_message_campaign_request = api_client.RequestBody(
    content={
    ...
    async def _aupdate_schedule_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/legacy-cloud/campaigns/schedule',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_reschedule_message_campaign_request.serialize(body, content_type)
