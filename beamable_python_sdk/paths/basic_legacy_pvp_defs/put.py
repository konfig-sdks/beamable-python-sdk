...
class BaseApi(api_client.Api):
    ...
    def _create_or_update_definition_mapped_args(
        self,
    ...
    async def _acreate_or_update_definition_oapg(
        self,
    ...
    def _create_or_update_definition_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateOrUpdateDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_or_update_definition(
        self,
        lbid: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._create_or_update_definition_mapped_args(
            lbid=lbid,
        )
        return await self._acreate_or_update_definition_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_or_update_definition(
        ...
        return self._create_or_update_definition_oapg(
            body=args.body,
        )

class CreateOrUpdateDefinition(BaseApi):
    ...
    async def acreate_or_update_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_or_update_definition(
            lbid=lbid,
            **kwargs,
        )
        if validate:
    ...
    def create_or_update_definition(
        ...
        raw_response = self.raw.create_or_update_definition(
            lbid=lbid,
        )
        if validate:
            return EmptyResponsePydantic(**raw_response.body)
