...
class BaseApi(api_client.Api):
    ...
    def _create_custom_notification_mapped_args(
        self,
    ...
    async def _acreate_custom_notification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/notification/custom',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_custom_notification_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateCustomNotificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_custom_notification(
        self,
        payload: typing.Optional[NotificationRequestData] = None,
        dbid: typing.Optional[int] = None,
        custom_channel_suffix: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_custom_notification_mapped_args(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
        )
        return await self._acreate_custom_notification_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_custom_notification(
        ...
        return self._create_custom_notification_oapg(
            body=args.body,
        )

class CreateCustomNotification(BaseApi):
    ...
    async def acreate_custom_notification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_custom_notification(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
    ...
    def create_custom_notification(
        ...
        raw_response = self.raw.create_custom_notification(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
