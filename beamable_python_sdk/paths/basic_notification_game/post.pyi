...
class BaseApi(api_client.Api):
    ...
    def _post_notification_mapped_args(
        self,
    ...
    async def _apost_notification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/notification/game',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class PostNotificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apost_notification(
        self,
        payload: typing.Optional[NotificationRequestData] = None,
        dbid: typing.Optional[int] = None,
        custom_channel_suffix: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._post_notification_mapped_args(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
        )
        return await self._apost_notification_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def post_notification(
        ...
        return self._post_notification_oapg(
            body=args.body,
        )

class PostNotification(BaseApi):
    ...
    async def apost_notification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apost_notification(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
    ...
    def post_notification(
        ...
        raw_response = self.raw.post_notification(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
