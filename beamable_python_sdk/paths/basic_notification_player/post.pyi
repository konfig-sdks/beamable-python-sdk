...
class BaseApi(api_client.Api):
    ...
    def _send_player_notification_mapped_args(
        self,
    ...
    async def _asend_player_notification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/notification/player',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _send_player_notification_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SendPlayerNotificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asend_player_notification(
        self,
        payload: typing.Optional[NotificationRequestData] = None,
        dbid: typing.Optional[int] = None,
        custom_channel_suffix: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._send_player_notification_mapped_args(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
        )
        return await self._asend_player_notification_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def send_player_notification(
        ...
        return self._send_player_notification_oapg(
            body=args.body,
        )

class SendPlayerNotification(BaseApi):
    ...
    async def asend_player_notification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asend_player_notification(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
    ...
    def send_player_notification(
        ...
        raw_response = self.raw.send_player_notification(
            payload=payload,
            dbid=dbid,
            custom_channel_suffix=custom_channel_suffix,
            dbids=dbids,
