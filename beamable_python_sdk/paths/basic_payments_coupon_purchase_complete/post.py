...
class BaseApi(api_client.Api):
    ...
    def _complete_purchase_0_mapped_args(
        self,
        txid: int,
    ...
    async def _acomplete_purchase_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/coupon/purchase/complete',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class CompletePurchase0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acomplete_purchase_0(
        self,
        txid: int,
        receipt: typing.Optional[str] = None,
        price_in_local_currency: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._complete_purchase_0_mapped_args(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
        )
        return await self._acomplete_purchase_0_oapg(
            body=args.body,
            **kwargs,
        )
    
    def complete_purchase_0(
        self,
        txid: int,
        receipt: typing.Optional[str] = None,
        price_in_local_currency: typing.Optional[str] = None,
        ...
        return self._complete_purchase_0_oapg(
            body=args.body,
        )

class CompletePurchase0(BaseApi):
    ...
    async def acomplete_purchase_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acomplete_purchase_0(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
    ...
    def complete_purchase_0(
        ...
        raw_response = self.raw.complete_purchase_0(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
