...
class BaseApi(api_client.Api):
    ...
    def _facebook_purchase_complete_mapped_args(
        self,
        txid: int,
    ...
    async def _afacebook_purchase_complete_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/facebook/purchase/complete',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _facebook_purchase_complete_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class FacebookPurchaseCompleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afacebook_purchase_complete(
        self,
        txid: int,
        receipt: typing.Optional[str] = None,
        price_in_local_currency: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._facebook_purchase_complete_mapped_args(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
        )
        return await self._afacebook_purchase_complete_oapg(
            body=args.body,
            **kwargs,
        )
    
    def facebook_purchase_complete(
        self,
        txid: int,
        receipt: typing.Optional[str] = None,
        price_in_local_currency: typing.Optional[str] = None,
        ...
        return self._facebook_purchase_complete_oapg(
            body=args.body,
        )

class FacebookPurchaseComplete(BaseApi):
    ...
    async def afacebook_purchase_complete(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afacebook_purchase_complete(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
    ...
    def facebook_purchase_complete(
        ...
        raw_response = self.raw.facebook_purchase_complete(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
