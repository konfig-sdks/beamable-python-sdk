...
class BaseApi(api_client.Api):
    ...
    def _itunes_purchase_track_mapped_args(
        self,
    ...
    async def _aitunes_purchase_track_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/itunes/purchase/track',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _itunes_purchase_track_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ItunesPurchaseTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aitunes_purchase_track(
        self,
        price_in_local_currency: typing.Union[int, float],
        sku_name: typing.Optional[str] = None,
        sku_product_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._itunes_purchase_track_mapped_args(
        ...
        return await self._aitunes_purchase_track_oapg(
            body=args.body,
            **kwargs,
        )
    
    def itunes_purchase_track(
        self,
        price_in_local_currency: typing.Union[int, float],
        sku_name: typing.Optional[str] = None,
        sku_product_id: typing.Optional[str] = None,
        ...
        return self._itunes_purchase_track_oapg(
            body=args.body,
        )

class ItunesPurchaseTrack(BaseApi):
    ...
    async def aitunes_purchase_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aitunes_purchase_track(
            price_in_local_currency=price_in_local_currency,
            sku_name=sku_name,
            sku_product_id=sku_product_id,
            store=store,
    ...
    def itunes_purchase_track(
        ...
        raw_response = self.raw.itunes_purchase_track(
            price_in_local_currency=price_in_local_currency,
            sku_name=sku_name,
            sku_product_id=sku_product_id,
            store=store,
