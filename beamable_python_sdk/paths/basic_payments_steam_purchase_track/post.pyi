...
class BaseApi(api_client.Api):
    ...
    def _track_purchase_post_3_mapped_args(
        self,
    ...
    async def _atrack_purchase_post_3_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/steam/purchase/track',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _track_purchase_post_3_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class TrackPurchasePost3Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def atrack_purchase_post_3(
        self,
        price_in_local_currency: typing.Union[int, float],
        sku_name: typing.Optional[str] = None,
        sku_product_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._track_purchase_post_3_mapped_args(
        ...
        return await self._atrack_purchase_post_3_oapg(
            body=args.body,
            **kwargs,
        )
    
    def track_purchase_post_3(
        self,
        price_in_local_currency: typing.Union[int, float],
        sku_name: typing.Optional[str] = None,
        sku_product_id: typing.Optional[str] = None,
        ...
        return self._track_purchase_post_3_oapg(
            body=args.body,
        )

class TrackPurchasePost3(BaseApi):
    ...
    async def atrack_purchase_post_3(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.atrack_purchase_post_3(
            price_in_local_currency=price_in_local_currency,
            sku_name=sku_name,
            sku_product_id=sku_product_id,
            store=store,
    ...
    def track_purchase_post_3(
        ...
        raw_response = self.raw.track_purchase_post_3(
            price_in_local_currency=price_in_local_currency,
            sku_name=sku_name,
            sku_product_id=sku_product_id,
            store=store,
