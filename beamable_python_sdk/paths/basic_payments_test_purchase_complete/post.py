...
class BaseApi(api_client.Api):
    ...
    def _complete_purchase_mapped_args(
        self,
        txid: int,
    ...
    async def _acomplete_purchase_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/test/purchase/complete',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class CompletePurchaseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acomplete_purchase(
        self,
        txid: int,
        receipt: typing.Optional[str] = None,
        price_in_local_currency: typing.Optional[str] = None,
    ...
    def complete_purchase(
        ...
        return self._complete_purchase_oapg(
            body=args.body,
        )

class CompletePurchase(BaseApi):
    ...
    async def acomplete_purchase(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acomplete_purchase(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
    ...
    def complete_purchase(
        ...
        raw_response = self.raw.complete_purchase(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
