...
class BaseApi(api_client.Api):
    ...
    def _process_complete_mapped_args(
        self,
        txid: int,
    ...
    async def _aprocess_complete_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/windows/purchase/complete',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class ProcessCompleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocess_complete(
        self,
        txid: int,
        receipt: typing.Optional[str] = None,
        price_in_local_currency: typing.Optional[str] = None,
    ...
    def process_complete(
        ...
        return self._process_complete_oapg(
            body=args.body,
        )

class ProcessComplete(BaseApi):
    ...
    async def aprocess_complete(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aprocess_complete(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
    ...
    def process_complete(
        ...
        raw_response = self.raw.process_complete(
            txid=txid,
            receipt=receipt,
            price_in_local_currency=price_in_local_currency,
            iso_currency_symbol=iso_currency_symbol,
