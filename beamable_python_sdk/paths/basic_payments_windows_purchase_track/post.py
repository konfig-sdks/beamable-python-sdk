...
class BaseApi(api_client.Api):
    ...
    def _windows_purchase_track_mapped_args(
        self,
    ...
    async def _awindows_purchase_track_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/payments/windows/purchase/track',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _windows_purchase_track_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class WindowsPurchaseTrackRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def awindows_purchase_track(
        self,
        price_in_local_currency: typing.Union[int, float],
        sku_name: typing.Optional[str] = None,
        sku_product_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._windows_purchase_track_mapped_args(
        ...
        return await self._awindows_purchase_track_oapg(
            body=args.body,
            **kwargs,
        )
    
    def windows_purchase_track(
        self,
        price_in_local_currency: typing.Union[int, float],
        sku_name: typing.Optional[str] = None,
        sku_product_id: typing.Optional[str] = None,
        ...
        return self._windows_purchase_track_oapg(
            body=args.body,
        )

class WindowsPurchaseTrack(BaseApi):
    ...
    async def awindows_purchase_track(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.awindows_purchase_track(
            price_in_local_currency=price_in_local_currency,
            sku_name=sku_name,
            sku_product_id=sku_product_id,
            store=store,
    ...
    def windows_purchase_track(
        ...
        raw_response = self.raw.windows_purchase_track(
            price_in_local_currency=price_in_local_currency,
            sku_name=sku_name,
            sku_product_id=sku_product_id,
            store=store,
