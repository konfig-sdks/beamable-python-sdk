...
class BaseApi(api_client.Api):
    ...
    def _check_customer_status_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acheck_customer_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/realms/is-customer',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _check_customer_status_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class CheckCustomerStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_customer_status(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._check_customer_status_mapped_args(
        )
        return await self._acheck_customer_status_oapg(
            **kwargs,
        )
    ...
    def check_customer_status(
        ...
        return self._check_customer_status_oapg(
        )

class CheckCustomerStatus(BaseApi):
    ...
    async def acheck_customer_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_customer_status(
            **kwargs,
        )
        if validate:
    ...
    def check_customer_status(
        ...
        raw_response = self.raw.check_customer_status(
        )
        if validate:
            return EmptyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(EmptyResponsePydantic, raw_response.body)
