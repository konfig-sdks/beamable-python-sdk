...
from beamable_python_sdk.model.create_project_request import CreateProjectRequest as CreateProjectRequestSchema
from beamable_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from beamable_python_sdk.type.create_project_request import CreateProjectRequest
...
from beamable_python_sdk.pydantic.create_project_request import CreateProjectRequest as CreateProjectRequestPydantic
...
class BaseApi(api_client.Api):
    ...
    def _create_project_real_mapped_args(
        self,
        name: str,
        plan: typing.Optional[str] = None,
        sharded: typing.Optional[bool] = None,
    ...
    async def _acreate_project_real_oapg(
        self,
...
class CreateProjectRealRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_project_real(
        self,
        name: str,
        plan: typing.Optional[str] = None,
        sharded: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_project_real_mapped_args(
            name=name,
            plan=plan,
            sharded=sharded,
            parent=parent,
        )
        return await self._acreate_project_real_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_project_real(
        ...
        return self._create_project_real_oapg(
            body=args.body,
        )

class CreateProjectReal(BaseApi):
    ...
    async def acreate_project_real(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_project_real(
            name=name,
            plan=plan,
            sharded=sharded,
            parent=parent,
    ...
    def create_project_real(
        ...
        raw_response = self.raw.create_project_real(
            name=name,
            plan=plan,
            sharded=sharded,
            parent=parent,
