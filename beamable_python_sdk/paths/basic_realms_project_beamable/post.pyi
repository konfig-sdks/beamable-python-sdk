...
class BaseApi(api_client.Api):
    ...
    def _create_beamable_mapped_args(
        self,
        name: str,
    ...
    async def _acreate_beamable_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/realms/project/beamable',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class CreateBeamableRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_beamable(
        self,
        name: str,
        plan: typing.Optional[str] = None,
        sharded: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._create_beamable_mapped_args(
            name=name,
            plan=plan,
            sharded=sharded,
            parent=parent,
        )
        return await self._acreate_beamable_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_beamable(
        ...
        return self._create_beamable_oapg(
            body=args.body,
        )

class CreateBeamable(BaseApi):
    ...
    async def acreate_beamable(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_beamable(
            name=name,
            plan=plan,
            sharded=sharded,
            parent=parent,
    ...
    def create_beamable(
        ...
        raw_response = self.raw.create_beamable(
            name=name,
            plan=plan,
            sharded=sharded,
            parent=parent,
