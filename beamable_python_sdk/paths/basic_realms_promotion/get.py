...
from beamable_python_sdk.model.promote_realm_response import PromoteRealmResponse as PromoteRealmResponseSchema

from beamable_python_sdk.type.promote_realm_response import PromoteRealmResponse

from ...api_client import Dictionary
from beamable_python_sdk.pydantic.promote_realm_response import PromoteRealmResponse as PromoteRealmResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PromoteRealmResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PromoteRealmResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_promotion_data_mapped_args(
        self,
        source_pid: str,
    ...
    async def _aget_promotion_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/realms/promotion',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPromotionDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_promotion_data(
        self,
        source_pid: str,
        promotions: typing.Optional[typing.List[str]] = None,
        content_manifest_ids: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._get_promotion_data_mapped_args(
            source_pid=source_pid,
            promotions=promotions,
            content_manifest_ids=content_manifest_ids,
        )
        return await self._aget_promotion_data_oapg(
    ...
    def get_promotion_data(
        ...
        return self._get_promotion_data_oapg(
            query_params=args.query,
        )

class GetPromotionData(BaseApi):
    ...
    async def aget_promotion_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PromoteRealmResponsePydantic:
        raw_response = await self.raw.aget_promotion_data(
            source_pid=source_pid,
            promotions=promotions,
            content_manifest_ids=content_manifest_ids,
            **kwargs,
        ...
        if validate:
            return PromoteRealmResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PromoteRealmResponsePydantic, raw_response.body)
    ...
    def get_promotion_data(
        ...
        raw_response = self.raw.get_promotion_data(
            source_pid=source_pid,
            promotions=promotions,
            content_manifest_ids=content_manifest_ids,
        )
