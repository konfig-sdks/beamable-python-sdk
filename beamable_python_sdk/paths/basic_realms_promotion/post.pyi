...
class BaseApi(api_client.Api):
    ...
    def _create_promotion_mapped_args(
        self,
        source_pid: str,
    ...
    async def _acreate_promotion_oapg(
        self,
...
class CreatePromotionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_promotion(
        self,
        source_pid: str,
        promotions: typing.Optional[PromoteRealmRequestPromotions] = None,
        content_manifest_ids: typing.Optional[PromoteRealmRequestContentManifestIds] = None,
        **kwargs,
        ...
        args = self._create_promotion_mapped_args(
            source_pid=source_pid,
            promotions=promotions,
            content_manifest_ids=content_manifest_ids,
        )
        return await self._acreate_promotion_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_promotion(
        ...
        return self._create_promotion_oapg(
            body=args.body,
        )

class CreatePromotion(BaseApi):
    ...
    async def acreate_promotion(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_promotion(
            source_pid=source_pid,
            promotions=promotions,
            content_manifest_ids=content_manifest_ids,
            **kwargs,
    ...
    def create_promotion(
        ...
        raw_response = self.raw.create_promotion(
            source_pid=source_pid,
            promotions=promotions,
            content_manifest_ids=content_manifest_ids,
        )
