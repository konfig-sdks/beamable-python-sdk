...
from beamable_python_sdk.model.session_history_response import SessionHistoryResponse as SessionHistoryResponseSchema

from beamable_python_sdk.type.session_history_response import SessionHistoryResponse

from ...api_client import Dictionary
from beamable_python_sdk.pydantic.session_history_response import SessionHistoryResponse as SessionHistoryResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = SessionHistoryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: SessionHistoryResponse
    ...
    async def _aget_history_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/session/history',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetHistory(BaseApi):
    ...
    async def aget_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> SessionHistoryResponsePydantic:
        ...
        if validate:
            return SessionHistoryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(SessionHistoryResponsePydantic, raw_response.body)
