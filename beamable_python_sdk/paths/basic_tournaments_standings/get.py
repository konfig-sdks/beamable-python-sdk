...
class BaseApi(api_client.Api):
    ...
    def _get_standings_mapped_args(
        self,
    ...
    async def _aget_standings_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/basic/tournaments/standings',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetStandingsRaw(BaseApi):
    ...
    async def aget_standings(
        ...
        **kwargs,
        ...
        args = self._get_standings_mapped_args(
        ...
        return await self._aget_standings_oapg(
    ...
    def get_standings(
        ...
        return self._get_standings_oapg(
            query_params=args.query,
        )

class GetStandings(BaseApi):
    ...
    async def aget_standings(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_standings(
            tournament_id=tournament_id,
            max=max,
            focus=focus,
            cycle=cycle,
    ...
    def get_standings(
        ...
        raw_response = self.raw.get_standings(
            tournament_id=tournament_id,
            max=max,
            focus=focus,
            cycle=cycle,
