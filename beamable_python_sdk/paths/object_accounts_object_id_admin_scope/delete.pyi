...
class BaseApi(api_client.Api):
    ...
    def _delete_admin_scope_mapped_args(
        self,
        object_id: str,
    ...
    async def _adelete_admin_scope_oapg(
        self,
...
class DeleteAdminScopeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_admin_scope(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_admin_scope_mapped_args(
            object_id=object_id,
        )
        return await self._adelete_admin_scope_oapg(
    ...
    def delete_admin_scope(
        ...
        return self._delete_admin_scope_oapg(
            path_params=args.path,
        )

class DeleteAdminScope(BaseApi):
    ...
    async def adelete_admin_scope(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_admin_scope(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_admin_scope(
        ...
        raw_response = self.raw.delete_admin_scope(
            object_id=object_id,
        )
        if validate:
            return EmptyResponsePydantic(**raw_response.body)
