...
from beamable_python_sdk.model.update_role import UpdateRole as UpdateRoleSchema

from beamable_python_sdk.type.update_role import UpdateRole
...
from beamable_python_sdk.pydantic.update_role import UpdateRole as UpdateRolePydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateRoleSchema


request_body_update_role = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_admin_scope_mapped_args(
        self,
        object_id: str,
    ...
    async def _aupdate_admin_scope_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/accounts/{objectId}/admin/scope',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_update_role.serialize(body, content_type)
...
class UpdateAdminScopeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_admin_scope(
        self,
        object_id: str,
        cid: typing.Optional[str] = None,
        realm: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_admin_scope_mapped_args(
            object_id=object_id,
            cid=cid,
            realm=realm,
            role=role,
        )
        return await self._aupdate_admin_scope_oapg(
            body=args.body,
    ...
    def update_admin_scope(
        ...
        return self._update_admin_scope_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateAdminScope(BaseApi):
    ...
    async def aupdate_admin_scope(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_admin_scope(
            object_id=object_id,
            cid=cid,
            realm=realm,
            role=role,
    ...
    def update_admin_scope(
        ...
        raw_response = self.raw.update_admin_scope(
            object_id=object_id,
            cid=cid,
            realm=realm,
            role=role,
