...
class RemoveRoleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_role(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_role_mapped_args(
            object_id=object_id,
        )
        return await self._aremove_role_oapg(
    ...
    def remove_role(
        ...
        return self._remove_role_oapg(
            path_params=args.path,
        )

class RemoveRole(BaseApi):
    ...
    async def aremove_role(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_role(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def remove_role(
        ...
        raw_response = self.raw.remove_role(
            object_id=object_id,
        )
        if validate:
            return EmptyResponsePydantic(**raw_response.body)
