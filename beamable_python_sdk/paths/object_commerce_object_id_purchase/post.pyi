...
from beamable_python_sdk.model.purchase_request import PurchaseRequest as PurchaseRequestSchema
from beamable_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from beamable_python_sdk.type.purchase_request import PurchaseRequest
...
from beamable_python_sdk.pydantic.purchase_request import PurchaseRequest as PurchaseRequestPydantic
...
class BaseApi(api_client.Api):
    ...
    def _purchase_item_mapped_args(
        self,
        object_id: str,
    ...
    async def _apurchase_item_oapg(
        self,
...
class PurchaseItemRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apurchase_item(
        self,
        object_id: str,
        purchase_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._purchase_item_mapped_args(
            object_id=object_id,
            purchase_id=purchase_id,
        )
        return await self._apurchase_item_oapg(
            body=args.body,
    ...
    def purchase_item(
        ...
        return self._purchase_item_oapg(
            body=args.body,
            path_params=args.path,
        )

class PurchaseItem(BaseApi):
    ...
    async def apurchase_item(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apurchase_item(
            object_id=object_id,
            purchase_id=purchase_id,
            **kwargs,
        )
    ...
    def purchase_item(
        ...
        raw_response = self.raw.purchase_item(
            object_id=object_id,
            purchase_id=purchase_id,
        )
        if validate:
