...
class BaseApi(api_client.Api):
    ...
    def _delete_event_content_mapped_args(
        self,
        object_id: str,
    ...
    async def _adelete_event_content_oapg(
        self,
    ...
    def _delete_event_content_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteEventContentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_event_content(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_event_content_mapped_args(
            object_id=object_id,
        )
        return await self._adelete_event_content_oapg(
    ...
    def delete_event_content(
        ...
        return self._delete_event_content_oapg(
            path_params=args.path,
        )

class DeleteEventContent(BaseApi):
    ...
    async def adelete_event_content(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_event_content(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_event_content(
        ...
        raw_response = self.raw.delete_event_content(
            object_id=object_id,
        )
        if validate:
            return CommonResponsePydantic(**raw_response.body)
