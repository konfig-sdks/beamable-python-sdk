...
class BaseApi(api_client.Api):
    ...
    def _refresh_object_events_mapped_args(
        self,
        object_id: str,
    ...
    async def _arefresh_object_events_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/events/{objectId}/refresh',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _refresh_object_events_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RefreshObjectEventsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefresh_object_events(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._refresh_object_events_mapped_args(
            object_id=object_id,
        )
        return await self._arefresh_object_events_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def refresh_object_events(
        self,
        object_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._refresh_object_events_oapg(
            path_params=args.path,
        )

class RefreshObjectEvents(BaseApi):
    ...
    async def arefresh_object_events(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arefresh_object_events(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def refresh_object_events(
        ...
        raw_response = self.raw.refresh_object_events(
            object_id=object_id,
        )
        if validate:
            return CommonResponsePydantic(**raw_response.body)
