...
class BaseApi(api_client.Api):
    ...
    def _get_recommended_users_mapped_args(
        self,
        object_id: str,
    ...
    async def _aget_recommended_users_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/group-users/{objectId}/recommended',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_recommended_users_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetRecommendedUsersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recommended_users(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_recommended_users_mapped_args(
            object_id=object_id,
        )
        return await self._aget_recommended_users_oapg(
    ...
    def get_recommended_users(
        ...
        return self._get_recommended_users_oapg(
            path_params=args.path,
        )

class GetRecommendedUsers(BaseApi):
    ...
    async def aget_recommended_users(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_recommended_users(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def get_recommended_users(
        ...
        raw_response = self.raw.get_recommended_users(
            object_id=object_id,
        )
        if validate:
            return GroupSearchResponsePydantic(**raw_response.body)
