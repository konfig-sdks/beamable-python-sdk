...
from beamable_python_sdk.model.group_update import GroupUpdate as GroupUpdateSchema
from beamable_python_sdk.model.common_response import CommonResponse as CommonResponseSchema

from beamable_python_sdk.type.group_update import GroupUpdate
...
from beamable_python_sdk.pydantic.group_update import GroupUpdate as GroupUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = GroupUpdateSchema


request_body_group_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_object_group_mapped_args(
        self,
        object_id: str,
        ...
        requirement: typing.Optional[int] = None,
    ...
    async def _aupdate_object_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/groups/{objectId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_group_update.serialize(body, content_type)
...
class UpdateObjectGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_object_group(
        self,
        object_id: str,
        name: typing.Optional[str] = None,
        enrollment_type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_object_group_mapped_args(
            object_id=object_id,
            name=name,
        ...
        return await self._aupdate_object_group_oapg(
            body=args.body,
...
class UpdateObjectGroup(BaseApi):
    ...
    async def aupdate_object_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_object_group(
            object_id=object_id,
            name=name,
            enrollment_type=enrollment_type,
            tag=tag,
    ...
    def update_object_group(
        ...
        raw_response = self.raw.update_object_group(
            object_id=object_id,
            name=name,
            enrollment_type=enrollment_type,
            tag=tag,
