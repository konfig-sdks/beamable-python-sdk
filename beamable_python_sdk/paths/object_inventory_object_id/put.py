...
class BaseApi(api_client.Api):
    ...
    def _update_inventory_object_mapped_args(
        self,
        empty: bool,
    ...
    async def _aupdate_inventory_object_oapg(
        self,
    ...
    def _update_inventory_object_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateInventoryObjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_inventory_object(
        self,
        empty: bool,
        currency_content_ids: InventoryUpdateRequestCurrencyContentIds,
        item_content_ids: InventoryUpdateRequestItemContentIds,
        ...
        **kwargs,
        ...
        args = self._update_inventory_object_mapped_args(
            empty=empty,
        ...
        return await self._aupdate_inventory_object_oapg(
            body=args.body,
    ...
    def update_inventory_object(
        ...
        return self._update_inventory_object_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateInventoryObject(BaseApi):
    ...
    async def aupdate_inventory_object(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_inventory_object(
            empty=empty,
            currency_content_ids=currency_content_ids,
            item_content_ids=item_content_ids,
            object_id=object_id,
    ...
    def update_inventory_object(
        ...
        raw_response = self.raw.update_inventory_object(
            empty=empty,
            currency_content_ids=currency_content_ids,
            item_content_ids=item_content_ids,
            object_id=object_id,
