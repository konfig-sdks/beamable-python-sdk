...
class BaseApi(api_client.Api):
    ...
    def _delete_object_by_id_mapped_args(
        self,
        object_id: str,
    ...
    async def _adelete_object_by_id_oapg(
        self,
...
class DeleteObjectByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_object_by_id(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_object_by_id_mapped_args(
            object_id=object_id,
        )
        return await self._adelete_object_by_id_oapg(
    ...
    def delete_object_by_id(
        ...
        return self._delete_object_by_id_oapg(
            path_params=args.path,
        )
...
class DeleteObjectById(BaseApi):
    ...
    async def adelete_object_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_object_by_id(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_object_by_id(
        ...
        raw_response = self.raw.delete_object_by_id(
            object_id=object_id,
        )
        if validate:
            return CommonResponsePydantic(**raw_response.body)
