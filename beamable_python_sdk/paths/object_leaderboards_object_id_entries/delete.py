...
class BaseApi(api_client.Api):
    ...
    def _delete_entries_mapped_args(
        self,
        object_id: str,
    ...
    async def _adelete_entries_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/leaderboards/{objectId}/entries',
            auth_settings=_auth,
            headers=_headers,
        )
...
class DeleteEntriesRaw(BaseApi):
    ...
    async def adelete_entries(
        ...
        **kwargs,
        ...
        args = self._delete_entries_mapped_args(
            object_id=object_id,
        )
        return await self._adelete_entries_oapg(
    ...
    def delete_entries(
        ...
        return self._delete_entries_oapg(
            path_params=args.path,
        )

class DeleteEntries(BaseApi):
    ...
    async def adelete_entries(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_entries(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_entries(
        ...
        raw_response = self.raw.delete_entries(
            object_id=object_id,
        )
        if validate:
            return CommonResponsePydantic(**raw_response.body)
