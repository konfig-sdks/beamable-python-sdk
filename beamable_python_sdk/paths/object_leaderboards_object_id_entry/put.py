...
from beamable_python_sdk.model.leaderboard_add_request import LeaderboardAddRequest as LeaderboardAddRequestSchema
from beamable_python_sdk.model.leaderboard_add_request_stats import LeaderboardAddRequestStats as LeaderboardAddRequestStatsSchema
...
from beamable_python_sdk.type.leaderboard_add_request import LeaderboardAddRequest
...
from beamable_python_sdk.pydantic.leaderboard_add_request_stats import LeaderboardAddRequestStats as LeaderboardAddRequestStatsPydantic
from beamable_python_sdk.pydantic.leaderboard_add_request import LeaderboardAddRequest as LeaderboardAddRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = LeaderboardAddRequestSchema


request_body_leaderboard_add_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_entry_mapped_args(
        ...
        id: int,
        object_id: str,
        max_score: typing.Optional[typing.Union[int, float]] = None,
        stats: typing.Optional[LeaderboardAddRequestStats] = None,
        min_score: typing.Optional[typing.Union[int, float]] = None,
        ...
        if max_score is not None:
            _body["maxScore"] = max_score
        if stats is not None:
            _body["stats"] = stats
        if score is not None:
            _body["score"] = score
        if min_score is not None:
            _body["minScore"] = min_score
        if id is not None:
            _body["id"] = id
    ...
    async def _aupdate_entry_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/leaderboards/{objectId}/entry',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_leaderboard_add_request.serialize(body, content_type)
