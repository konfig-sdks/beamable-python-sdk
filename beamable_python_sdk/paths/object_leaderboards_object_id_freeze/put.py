...
class BaseApi(api_client.Api):
    ...
    def _create_freeze_request_mapped_args(
        self,
        object_id: str,
    ...
    async def _acreate_freeze_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/leaderboards/{objectId}/freeze',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _create_freeze_request_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateFreezeRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_freeze_request(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._create_freeze_request_mapped_args(
            object_id=object_id,
        )
        return await self._acreate_freeze_request_oapg(
    ...
    def create_freeze_request(
        ...
        return self._create_freeze_request_oapg(
            path_params=args.path,
        )

class CreateFreezeRequest(BaseApi):
    ...
    async def acreate_freeze_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_freeze_request(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def create_freeze_request(
        ...
        raw_response = self.raw.create_freeze_request(
            object_id=object_id,
        )
        if validate:
            return CommonResponsePydantic(**raw_response.body)
