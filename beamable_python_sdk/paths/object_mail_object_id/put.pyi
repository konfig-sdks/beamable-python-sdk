...
class BaseApi(api_client.Api):
    ...
    def _update_object_mail_mapped_args(
        self,
        mail_id: int,
        object_id: str,
    ...
    async def _aupdate_object_mail_oapg(
        self,
...
class UpdateObjectMailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_object_mail(
        self,
        mail_id: int,
        object_id: str,
        body: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_object_mail_mapped_args(
            mail_id=mail_id,
            object_id=object_id,
            body=body,
            expires=expires,
        ...
        return await self._aupdate_object_mail_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_object_mail(
        self,
        mail_id: int,
        object_id: str,
        body: typing.Optional[str] = None,
        ...
        return self._update_object_mail_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateObjectMail(BaseApi):
    ...
    async def aupdate_object_mail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_object_mail(
            mail_id=mail_id,
            object_id=object_id,
            body=body,
            expires=expires,
    ...
    def update_object_mail(
        ...
        raw_response = self.raw.update_object_mail(
            mail_id=mail_id,
            object_id=object_id,
            body=body,
            expires=expires,
