...
class BaseApi(api_client.Api):
    ...
    def _matchmaking_delete_mapped_args(
        self,
        object_id: str,
    ...
    async def _amatchmaking_delete_oapg(
        self,
...
class MatchmakingDeleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amatchmaking_delete(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._matchmaking_delete_mapped_args(
            object_id=object_id,
        )
        return await self._amatchmaking_delete_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def matchmaking_delete(
        self,
        object_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._matchmaking_delete_oapg(
            path_params=args.path,
        )

class MatchmakingDelete(BaseApi):
    ...
    async def amatchmaking_delete(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amatchmaking_delete(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def matchmaking_delete(
        ...
        raw_response = self.raw.matchmaking_delete(
            object_id=object_id,
        )
        if validate:
            return EmptyResponsePydantic(**raw_response.body)
