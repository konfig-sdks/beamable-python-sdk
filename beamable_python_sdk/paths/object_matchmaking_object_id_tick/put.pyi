...
class BaseApi(api_client.Api):
    ...
    def _update_matchmaking_tick_mapped_args(
        self,
        object_id: str,
    ...
    async def _aupdate_matchmaking_tick_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/matchmaking/{objectId}/tick',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_matchmaking_tick_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateMatchmakingTickRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_matchmaking_tick(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._update_matchmaking_tick_mapped_args(
            object_id=object_id,
        )
        return await self._aupdate_matchmaking_tick_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def update_matchmaking_tick(
        self,
        object_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._update_matchmaking_tick_oapg(
            path_params=args.path,
        )

class UpdateMatchmakingTick(BaseApi):
    ...
    async def aupdate_matchmaking_tick(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_matchmaking_tick(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def update_matchmaking_tick(
        ...
        raw_response = self.raw.update_matchmaking_tick(
            object_id=object_id,
        )
        if validate:
            return EmptyResponsePydantic(**raw_response.body)
