...
class BaseApi(api_client.Api):
    ...
    def _get_payment_details_mapped_args(
        self,
        object_id: str,
    ...
    async def _aget_payment_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/object/payments/{objectId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetPaymentDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_payment_details(
        self,
        object_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_payment_details_mapped_args(
            object_id=object_id,
        )
        return await self._aget_payment_details_oapg(
    ...
    def get_payment_details(
        ...
        return self._get_payment_details_oapg(
            path_params=args.path,
        )

class GetPaymentDetails(BaseApi):
    ...
    async def aget_payment_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_payment_details(
            object_id=object_id,
            **kwargs,
        )
        if validate:
    ...
    def get_payment_details(
        ...
        raw_response = self.raw.get_payment_details(
            object_id=object_id,
        )
        if validate:
            return CommonResponsePydantic(**raw_response.body)
