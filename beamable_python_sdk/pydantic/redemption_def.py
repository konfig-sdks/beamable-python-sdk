...
from beamable_python_sdk.pydantic.redemption_def_whitelist import RedemptionDefWhitelist

class RedemptionDef(BaseModel):
    creator_gt: int = Field(alias='creatorGt')
    ...
    whitelist: typing.Optional[RedemptionDefWhitelist] = Field(None, alias='whitelist')
