...
class RequiredEventRewardContent(TypedDict):
    min: typing.Union[int, float]

class OptionalEventRewardContent(TypedDict, total=False):
...
class EventRewardContent(RequiredEventRewardContent, OptionalEventRewardContent):
    pass
