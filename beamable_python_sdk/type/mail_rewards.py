...
class RequiredMailRewards(TypedDict):
    pass

class OptionalMailRewards(TypedDict, total=False):
    currencies: typing.List[CurrencyChange]

    items: typing.List[ItemCreateRequest]

class MailRewards(RequiredMailRewards, OptionalMailRewards):
    pass
