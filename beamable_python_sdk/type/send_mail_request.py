...
class RequiredSendMailRequest(TypedDict):
    receiverGamerTag: int

    senderGamerTag: int

class OptionalSendMailRequest(TypedDict, total=False):
    body: str
...
class SendMailRequest(RequiredSendMailRequest, OptionalSendMailRequest):
    pass
